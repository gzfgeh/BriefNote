...
public class MenuAdapter {
	 ...
	 */
	    ...
	    private void fillOpenClosingAnimations(boolean isCloseAnimation, List<Animator> textAnimations, List<Animator> imageAnimations, int wrapperPosition) {
	        ...
	        com.nineoldandroids.animation.ObjectAnimator textAppearance = isCloseAnimation ?
	        ...
	        com.nineoldandroids.animation.ObjectAnimator textTranslation = isCloseAnimation ?
	        ...
	        com.nineoldandroids.animation.ObjectAnimator imageRotation = isCloseAnimation ?
